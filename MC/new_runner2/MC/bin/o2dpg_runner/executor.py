...
class WorkflowExecutor:
    ...
    def __init__(
        ...
        self.process_list: List[Tuple[int, subprocess.Popen]] = []
    ...
    # ----- task submission -----
    def submit(self, tid: int, nice: int) -> Optional[subprocess.Popen]:
        task = self.wf.stages[tid]
        ...
        if self.cfg.dry_run:
            ...
            return subprocess.Popen(["/bin/bash", "-c", dry], cwd=workdir)
